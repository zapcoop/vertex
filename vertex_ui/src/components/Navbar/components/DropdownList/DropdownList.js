...
const DropdownList = props => {
  ...
  const childToRender =
    child && child.type === ListGroup ? adjustInnerListGroup(child) : child;
  ...
  return (
    ...
    >
      {props.header && (
        <div className={classes.dropdownListHeader}>{props.header}</div>
      )}
      <ScrollBarContainer
        style={{ maxHeight: `${parseInt(props.listHeight)}px` }}
        className={classes.dropdownListContent}
      >
        {childToRender}
      </ScrollBarContainer>
      {props.footer && (
        <div className={classes.dropdownListFooter}>
          {props.footerUrl ? (
            <Link
              to={props.footerUrl}
              className={classes.dropdownListFooterLink}
            >
              {props.footer}
            </Link>
          ) : (
