...
class DefaultLayout extends React.Component {
  ...
  render() {
    ...
    const navbarLogo = getLogoBySkin.navbar(
      ...
      sidebarBigLogo = getLogoBySkin.sidebar(
        this.props.sidebarSkin,
        'big',
        this.props.skinColor,
      ),
      sidebarSlimLogo = getLogoBySkin.sidebar(
        this.props.sidebarSkin,
        'slim',
        this.props.skinColor,
      );
      ...
      >
              ...
              {this.props.currentScreenSize === SCREEN_SIZE_XS && (
                <div className="pull-right">
                  ...
                  <button
                    className="btn btn-outline navbar-toggle"
                    onClick={() =>
                      this.props.toggleNavbarExpanded(
                        !this.props.navbarExpanded,
                      )}
                    ref={ref => {
            ...
            >
              <Navbar.Collapse>
                ...
                <Nav>
                  {this.props.sidebarEnabled &&
                    this.props.currentScreenSize !== SCREEN_SIZE_XS && (
                      <NavItem onClick={() => this.toggleSidebarSlim()}>
                ...
                <Nav pullRight>
                  ...
                  <NavDropdown
                    ...
                    noCaret
                  >
                    <MenuItem header className="text-uppercase hidden-xs">
        ...
        >
          ...
          >
            ...
            >
              <Tab eventKey={1} title={<span className="fa fa-calendar-o" />}>
                <RightSidebarTabs.First data={rightSidebarData} />
              </Tab>

              <Tab eventKey={2} title={<span className="fa fa-area-chart" />}>
                <RightSidebarTabs.Second data={rightSidebarData} />
              </Tab>

              <Tab eventKey={3} title={<span className="fa fa-users" />}>
                <RightSidebarTabs.Third data={rightSidebarData.Chat} />
              </Tab>

              <Tab eventKey={4} title={<span className="fa fa-list" />}>
                <RightSidebarTabs.Fourth />
              </Tab>

              <Tab eventKey={5} title={<span className="fa fa-gear" />}>
        ...
        <Footer fluid={!staticFootNavContainer}>
          <p className="text-gray-dark">
            ...
            <span className="text-gray-dark">
              © 2009 - 2016. Made by
              <i className="fa fa-fw fa-heart text-danger" /> New York, US
            </span>
          </p>
        </Footer>
