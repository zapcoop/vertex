    ...
    return (
        ...
        title={
          <span>
            <span className="hidden-xs">
              ...
              <Label bsStyle="info" withIcon pill>
                3
              </Label>
            </span>
            ...
            <span className="hidden-sm hidden-md hidden-lg">
              Messages
              <Label bsStyle="info" className="m-l-1" pill>
                3
              </Label>
            </span>
          </span>
      ...
      >
        <Navbar.DropdownList
          header={
            <div>
              <strong className="small text-uppercase">Messages</strong>
          ...
          footer={
            ...
            >
              See All Messages <i className="fa fa-angle-right fa-fw" />
            </div>
          }
                ...
                >
                  <Media>
                    ...
                    <Media.Body>
                      ...
                      <p className="m-y-0">{message.message}</p>
                    </Media.Body>
                  </Media>
                </LinkContainer>
              </ListGroupItem>
