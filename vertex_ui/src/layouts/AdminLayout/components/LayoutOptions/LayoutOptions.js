...
} from 'layouts/AdminLayout/modules/layout';
...
class LayoutOptions extends React.Component {
  ...
  render() {
    ...
    const parentClasses = `layout-options ${optionsVisible
      ? 'active'
      : ''} ${classes.parent}`;
          ...
          <Tabs defaultActiveKey={1} id="layout-options-tabs" bsStyle="panel">
            <Tab eventKey={1} title="Options" className="p-r-1">
              ...
              <FormGroup className="p-t-2">
                ...
                <Checkbox
                  onChange={ev =>
                    this.props.toggleNavbarFixed(ev.target.checked)}
                  checked={this.props.navbarEnabled}
                  inline
              ...
              <FormGroup>
                <Checkbox
                  onChange={ev =>
                    this.props.toggleSidebarFixed(ev.target.checked)}
                ...
                <Checkbox
                  onChange={ev =>
                    this.props.toggleSidebarAside(ev.target.checked)}
              ...
              <FormGroup className="p-t-2">
                ...
                <Checkbox
                  onChange={ev =>
                    this.props.toggleFooterFixed(ev.target.checked)}
