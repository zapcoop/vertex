...
import { AvatarImage, Charts, Sidebar, SlimProgressBar } from 'components';
      ...
      <Media>
        <Media.Left>
          <Link to="/apps/profile-details">
            <AvatarImage
              ...
              statusBorderColor={
                props.colorSidebar ? '#fff' : Colors.grayDarker
              }
            />
          </Link>
        </Media.Left>
        ...
        <Media.Right align="middle">
          <Link to="/apps/user-profile/edit/profile">
            <i className="fa fa-fw fa-gear text-gray-lighter" />
          </Link>
        </Media.Right>
      </Media>
      <div className="m-t-3">
