...
export const ACTION_SET_LAYOUT_SETTINGS_SAFE =
  'ACTION_SET_LAYOUT_SETTINGS_SAFE';
export const ACTION_SET_CURRENT_PAGE_SETTINGS =
  'ACTION_SET_CURRENT_PAGE_SETTINGS';
export const ACTION_SET_CURRENT_PAGE_SETTINGS_LITERAL =
  'ACTION_SET_CURRENT_PAGE_SETTINGS_LITERAL';
...
const ACTION_HANDLERS = {
  ...
  [ACTION_SET_LAYOUT_SETTINGS_SAFE]: (state, action) => {
    return Object.assign(
      {},
      state,
      _.pick(action.settings, _.keys(action.settings)),
    );
  },
  ...
  [ACTION_CHANGE_SIDEBAR_ADDON]: (state, action) => {
    return Object.assign({}, state, {
      sidebarStyle:
        state.sidebarStyle === SIDEBAR_STYLE_SLIM
  ...
  [ACTION_TOGGLE_RSIDEBAR]: (state, action) => {
    return Object.assign({}, state, {
      rightSidebarEnabled: !state.rightSidebarEnabled,
    });
  },
...
export default function layoutReducer(state = initialState, action) {
  ...
  const optionsDiff = ((defaultOptions, currentOptions) => {
    ...
    for (let key of _.keys(defaultOptions)) {
      if (
        _.has(currentOptions, key) &&
        !_.isEqual(defaultOptions[key], currentOptions[key])
      ) {
    ...
    Object.assign({}, DEFAULT_SETTINGS, currentPageLayoutSettings),
    optionsOnly,
  );
